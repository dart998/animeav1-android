...
final class AppUi {
    ...
    static TextView title(Context c,String value,int sp){TextView v=text(c,value,sp,TEXT);v.setTypeface(Typeface.DEFAULT,Typeface.BOLD);return v;}
    static Button button(Context c,String value){Button b=new Button(c);b.setText(value);b.setTextColor(BG);b.setTextSize(13);b.setAllCaps(false);b.setBackground(round(BRAND,14));b.setMinHeight(dp(c,44));return b;}
